    ...
    return (
        <div className="mcq-input">
            ...
            {!enteredCorrectAnswer && questionEntered &&
                <form>
                    <div className="mb-3 w-75" style={{textAlign : "center", marginLeft : "auto", marginRight : "auto"}}>
                        <label htmlFor="correct-ans" className="form-label w-75">Enter correct answer :</label>
                        <input
                            className="form-control"
                            id="correct-ans"
                            aria-describedby="correct-ans"
                            autoComplete="off"
                            type="text"
            ...
            {enterOption &&
                <form>
                    <div className="mb-3">
                        <label htmlFor="qp-option" className="form-label">Enter Option : </label>
                        <input
                            className="form-control"
                            id="qp-option"
                            aria-describedby="qp-option"
                            autoComplete="off"
                            type="text"
