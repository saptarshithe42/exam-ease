	...
	return (
		<div className="create">
			...
			<div className="create-div">
				{!firstFormSubmitted &&
					<form className="create-form" onSubmit={submitFirstForm}>
						<div className="mb-3">
							<label htmlFor="qp-name" className="form-label">Question paper name : </label>
							<input
								type="text"
								className="form-control"
								id="qp-name"
								aria-describedby="qp-name"
								autoComplete="off"
						...
						<div className="mb-3">
							<label htmlFor="number-of-questions" className="form-label">Enter number of questions : </label>
							<input
								type="Number"
								className="form-control"
								id="number-of-questions"
								aria-describedby="number-of-questions"
								autoComplete="off"
						...
						<div className="mb-3">
							<label htmlFor="qp-time" className="form-label">Enter time in minutes : </label>
							<input
								className="form-control"
								id="qp-time"
								aria-describedby="qp-time"
								autoComplete="off"
								type="Number"
							...
							questionsList.map((question) => {
								return (
									...
									>
										...
										<QuestionViewComponent question={question} />
									</div>)
							})}


						{firstFormSubmitted && (numberOfQuestions == questionsList.length) &&
